...
Pod::Spec.new do |s|
  s.name              = "react-native-invitereferrals"
  s.version           = package_json["version"]
  s.summary           = package_json["description"]
  s.homepage          = "https://github.com/tagnpin/react-native-invitereferrals.git"
  s.license           = package_json["license"]
  s.author            = { package_json["author"] => package_json["author"] }
  s.platform          = :ios
  s.ios.deployment_target = '8.0'
  s.source            = { :git => "#{package_json["repository"]["url"]}.git", :tag => "#{s.version}" }
  s.source_files      = ['ios/RNInvitereferrals/*.{h,m}']
  ...
  # The Native InviteReferrals-iOS-SDK from cocoapods.
   s.dependency 'InviteReferrals', '4.3.3'
end